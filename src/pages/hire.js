  ...
  return (
    <Layout>
      ...
      <Content>
        ...
        <div>
          <SectionWrapper>
            Through my career, I always want to develop the best web
            applications. This goal motivates me to learn new technologies, go
            deep into an understanding what the customer needs and provide an
            optimal digital solution.
          </SectionWrapper>
          <SectionWrapper>
            If you are interested in applying my knowledge and experience to
            enhance your business, I consider consulting opportunities related
            to:
          </SectionWrapper>
          <ul>
            <StyledLi>
